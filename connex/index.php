                    ...
                    <div class="row">
                        ...
                        <?php
                            if(isset($_SESSION['user_name'])){
                                ...
                                <a href='my-profile.php?id=" . $_SESSION['user_id'] . "'><button class='btn btn-lg add-to-cart' style='margin: 20px; font-size: 20px; background-color: #3498db;'>profile</button></a>
                                <p style='font-size:20px; font-weight:bold;'>Welcome ". $_SESSION['user_name'] . "!</p>
                                ";
                            }else{
                                echo "
                                <a href='login.php'><button class='btn btn-lg add-to-cart' style='margin: 20px; font-size: 20px; background-color: #3498db;'>Login</button></a>
                                <a href='register.php'><button class='btn btn-lg add-to-cart' style='margin: 20px; font-size: 20px; background-color: #3498db;' onclick='login_div()'>Register</button></a>
