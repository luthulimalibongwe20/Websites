...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    } elseif (!preg_match(' /^[a-zA-Z\s]+$/', $input_id)) {
    ...
    if (empty($id_err) && empty($name_err) && empty($email_err) && empty($password_err) && empty($user_type_err)) {
    ...
    if (isset($_GET["id"]) && !empty(trim($_GET["id"]))) {
        ...
        if ($stmt = mysqli_prepare($link, $sql)) {
            ...
            if (mysqli_stmt_execute($stmt)) {
                ...
                if (mysqli_num_rows($result) == 1) {
                    ...
                    // URL doesn't contain a valid id. Redirect to error page or handle it accordingly
        ...
        // URL doesn't contain an id parameter. Redirect to error page or handle it accordingly
        header("location: error.php");
        exit();
    }
}
                ...
                <div class="col-md-12">
                    ...
                    <form action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']); ?>" method="post">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" id="id" name="id" class="form-control <?php echo (!empty($id_err)) ? 'is-invalid' : ''; ?>" value="<?php echo $id; ?>">
                        ...
                        <a href="index11.php" class="btn btn-secondary ml-2">Cancel</a>
                    </form>
                </div>
            </div>
        </div>
