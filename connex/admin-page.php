...
<head>
    ...
    <title>T-Shirts shop online</title>
...
<body id="index" class="lang-en country-za currency-zar layout-left-column page-index tax-display-enabled live_edit_0  1.7.8.8 ps_178
    ...
    <main>
        ...
        <h1 style="margin:20px ; font-size:50px;">Admin Dashboard</h1>
        
        <div class="products" style="border:solid; border-color:lightblue; margin: 100px;padding: 7px;">
        <label for="cars">User emails </label>
            
            <select name="product_id" id="product_id">
        <?php 
                $emails = select_all($conn, $dbname, 'users', 'email'); 
        ...
        <form action='load-page.php' method='post'>
            <label for="cars">Select a product ID to update: </label>
            
            <select name="product_id" id="product_id">
                
                <?php 
                $product_ids = select_all($conn, $dbname, 'products', 'id'); 
                foreach ($product_ids as $key=>$val)
                ?>
                
            </select>

            <label for="cars">Select a property to update to update: </label>
            ...
            <label for="cars">New Value: </label>
