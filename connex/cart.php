...
if(isset($_POST['update_products'])){
   $update_quantity = $_POST['products_quantity'];
   $update_id = $_POST['products_id'];
   mysqli_query($conn, "UPDATE `products` SET quantity = '$update_quantity' WHERE id = '$update_id'") or die('query failed');
    ...
    <main>
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-md-4 hidden-sm-down2" id="_desktop_logo">
                            <h1>
                                <a href="index.php"><img class="logo img-responsive" src="images/logo.jpg" alt="Connex Store"></a>
                            </h1>
                        </div>
        ...
        <aside id="notifications">
            ...
            <div class="shopping-cart">
                ...
                <table>
                    <thead style='width: 100%; text-align: center; border:var(--border); border-radius: 100px; box-shadow: var(--box-shadow);
   background-color: var(--black);'>
      ...
      foreach ($_SESSION as $key=>$val){
         ...
         echo (" 
          ...
          <td style='font-weight:bold font-size:40px;'>R$price</td>
          <td>
          <input type='hidden' name='id' value='$id'>
          <input type='number' min='1' name='products' value='' style='width:100px; text-align:center;'>
          ...
          ");
          $grand_total +=(floatval($price) * intval($quantity));
        ...
        // else{
            //       echo '<tr><td style="padding:20px; text-transform:capitalize;" colspan="6">no item added</td></tr>';<td><a href='delete.php?remove=$id;' class='delete-btn'>remove</a></td>
            
            //    }
            
            ?>
   <tr class="table-bottom">
       <td colspan="4" style='font-weight:bold; font-size:40px;'>grand total :</td>
      <td style='font-weight:bold; font-size:40px;'>R<?php echo $grand_total; ?></td>
