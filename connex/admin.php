...
<head>
    ...
    <title>My connex</title>
    <meta name="viewport" content="width=device-width, initial-scale=1">
    <link href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.0.0/css/all.min.css" rel="stylesheet" />
    <link rel="stylesheet" href="/login-page-in-html5-with-validation/login-page-in-html5-with-validation/style.css">
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-md-4 hidden-sm-down2" id="_desktop_logo">
                            <h1>
                                <a href="admin.php"><img class="logo img-responsive" src="images/logo.jpg" alt="Connex Store"></a>
                            </h1>
                        </div>
                       
                        
                                <!-- <a href='logout.php'><button class='btn btn-lg add-to-cart' style='margin: 20px; font-size: 20px; background-color: #3498db;'>logout</button></a> -->
                                
                                <?php
                            if(isset($_SESSION['admin_name'])){
                                echo "
                            <a href='logout.php'><button class='btn btn-lg add-to-cart' style='margin: 20px; font-size: 20px; background-color: #3498db;'>logout</button></a>
                            <a href='admin-profile.php?id=" . $_SESSION['admin_id'] . "'><button class='btn btn-lg add-to-cart' style='margin: 20px; font-size: 20px; background-color: #3498db;'>profile</button></a>   
                            <p style='font-size:20px; font-weight:bold;'>Welcome ". $_SESSION['admin_name'] . "!</p>
                                ";
                            }
                            ?>
...
<h2 class="pull-left">Dashboard Details</h2>
<a href="create.php" class="btn btn-success pull-right" style='background-color:#3498db;'><i class="fa fa-plus"></i> Add New Products</a>
<br>
<br>
<br>
<a href="index11.php" class="btn btn-success pull-right" style='background-color:#3498db;'><i class="fa fa-plus"></i> Profile Details.</a>
...
striped">';
echo "<thead>";
echo "<tr style='background-color: #3498db'>";
echo "<th>#</th>"; 
...
echo "<tr style='background-color:#949494;'>";
    echo "<td>" . $row['id'] . 
"</td>";
    echo "<td>" . $row['description'] .
"</td>";
$image = $row['image'];
    echo "<td style='width:20%;'> <img style='width:100%;' src='images/$image'> 
</td>";
    echo "<td>" . $row['price'] .
"</td>";
