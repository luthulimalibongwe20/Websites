...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (empty($name_err) && empty($email_err) && empty($password_err) && empty($user_type_err)) {
...
<body>
    <div class="wrapper">
        <div class="container-fluid">
            <div class="row">
                <div class="col-md-12">
                <h2 class="mt-5">Update Admin information</h2>
                    <p>Please edit the information and submit to update the Admin.</p>
