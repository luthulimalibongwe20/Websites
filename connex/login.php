...
if (isset($_POST['submit'])) {
   ...
   $select_user = mysqli_query($conn, "SELECT * FROM `user` WHERE password = '$pass' AND email = '$email'") or die('query failed');
...
<div class="container hook_box">
   ...
   <form action="" method="post">
      ...
      <input type="submit" name="submit" value="login now" class="btn" onclick="showMessage()">
